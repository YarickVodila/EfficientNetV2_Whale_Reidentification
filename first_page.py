...
class Ui_IIntegrationWhale(object):
    def setupUi(self, IIntegrationWhale):
        ...
        self.label.setText("")
        path = str(Path(__file__).parent / "assets" / "logo.jpg")
    ...
    def retranslateUi(self, IIntegrationWhale):
        ...
        self.label_2.setText(_translate("IIntegrationWhale",
                                        "Сгенерированные размечанные данные будут сохранены в корневом каталоге программы"))
