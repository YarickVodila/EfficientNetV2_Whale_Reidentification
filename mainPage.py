...
"border-radius: 5px;")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 158, 653))
...
"border-radius: 10px;")
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.BackButton)
